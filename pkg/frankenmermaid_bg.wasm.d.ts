...
export const diagram_fromOffscreenCanvas: (a: number, b: number, c: number) => void;
export const diagram_hitTestEdge: (a: number, b: number, c: number, d: number, e: number) => void;
export const diagram_hitTestNode: (a: number, b: number, c: number, d: number) => void;
