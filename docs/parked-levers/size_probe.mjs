...
console.log(
  "statement-lines per diagram: min",
  sizes[0],
  "p25",
  pct(0.25),
  "median",
...
console.log(
  "total statement lines across",
  sizes.length,
  "diagrams:",
  total,
  "mean",
  (total / sizes.length).toFixed(1),
);
...
for (const cut of [10, 20, 30]) {
  ...
  console.log(
    `diagrams with <=${cut} lines: ${n} (${((100 * n) / sizes.length).toFixed(0)}% of diagrams, ` +
